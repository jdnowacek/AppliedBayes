...
With a much larger sample size, the posterior has much higher certainty than with low sample size. The prior has far less effect on the posterior than the data when the sample size is so large. So, the posterior is very closely centered around the data estimate of the parameter.
