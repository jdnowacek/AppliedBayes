...
mod_reInits <- list(list(beta0 = 3, beta1 = 0, beta2 = 0, beta3 = 0, tau = 2), 
...
1.  Comment on how important each one of the covariates seems to be for the
    ...
    1.  Beta1 is the parameter representing the association of the binary
        ...
        interval contains 0 and is wide relative to the parameter value, we
        would not consider this to be one of our more important parameters.
    ...
    2.  Beta2 is the parameter representing the association between age and
        ...
        this parameter value, since that interval contains 0 and is wide
        relative to the parameter value, we would not consider this to be one of
    ...
    3.  Beta 3 is the parameter representing the association between exposure to
        ...
        this parameter value, since this interval is small relative to the
        parameter and does not include 0, we are inclined to consider this as an
        important predictor of birth weight.
